...
class Game {
    ...
    showShareDialog() {
        ...
        let message = '';
        if (level <= 10) {
            message = `I survived Level ${level}/100 in Space Battle! 🚀`;
        } else if (level <= 25) {
            message = `I reached Level ${level}/100 with ${score} points! 🎮`;
        } else if (level <= 50) {
            message = `I'm crushing it at Level ${level}/100 - ${score} points! 💪`;
        } else if (level <= 75) {
            message = `ELITE GAMER alert - I reached Level ${level}/100! ${score} points! 🔥`;
        } else {
            message = `LEGENDARY - I reached Level ${level}/100! Can you beat ${score} points? 🚀💜`;
        }
            ...
            <div id="share-dialog" class="share-dialog">
                <div class="share-content">
                    ...
                    <div class="share-buttons">
                        ...
                        <button class="share-btn" data-platform="generic">
                            🚀 Άλλο...
                        </button>
                    </div>
        ...
        switch (platform) {
            ...
            case 'generic':
                ...
                if (navigator.share) {
                    ...
                    alert('Το πρόγραμμα περιήγησης δεν υποστηρίζει κοινή χρήση');
                }
                break;
        }
